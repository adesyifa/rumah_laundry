...
<?php endif ?>
   ...
   <div id="order_ck" class="main-content">
                        ...
                        <div class="row-input">
                           ...
                           <div class="col-form m-1">
                              ...
                              <div class="form-grup">
                                 ...
                                 <input type="number" name="berat_qty_ck" placeholder="Berat (Kg)" autocomplete="off" id="kuantitas" min="0">
                              </div>
    ...
    document.getElementById('tgl_order_msk').setAttribute('min', todayDate);
    document.getElementById('tgl_order_klr').setAttribute('min', todayDate);
    </script>
                              <div class="form-grup">
