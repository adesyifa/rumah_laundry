						...
						<div class="card-body">
							<div class="card-panel">
								...
								<div class="panel-icon">
									<img src="<?=url('_assets/img/img/team.png')?>" alt="karyawan" height="48">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="card-panel">
								...
								<div class="panel-icon">
									<img src="<?=url('_assets/img/img/total_order.png')?>" alt="order" height="48">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="card-panel">
								...
								<div class="panel-icon">
									<img src="<?=url('_assets/img/img/jumlah_paket-removebg-preview.png')?>" alt="paket" height="48">
								</div>
							</div>
