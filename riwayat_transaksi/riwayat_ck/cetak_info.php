      ...
      <div class="invoice">
         <div class="invoice-content">
            <div class="invoice-header">
               <div class="logo">
                  <img src="<?=url('_assets/img/img/logo/logofix.png')?>" width="100" alt="Logo rumah laundry">
               </div>
            ...
            <div class="invoice-body">
               ...
               <div class="invoice-footer">
                  <h3 class="foot_logo"><span>Go</span> Laundry</h3>
         ...
         <div class="printbtn" id="btnPrint">
            <img src="<?=url('_assets/img/img/printer.png')?>" width="48" alt="print icon">
