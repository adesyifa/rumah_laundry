...
<head>
	...
	<link rel="shortcut icon" href="<?= url('_assets/img/img/logo/logofix.png') ?>" type="image/x-icon">
</head>
<body>
	...
	<div class="box">
		<div class="box-content">
			<div class="col box__left">
				<div class="logo">
					<img src="<?= url('_assets/img/img/logo/logofix.png') ?>" alt="">
				</div>
				...
				<div class="box__left-form">
					<form action="" method="post">
						...
						<div class="box__left">
							<a href="karyawan/tambah.php" class=""> Belum Punya Akun?</a>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="col box__right">
				<div class="box__right-content">
					...
					<img src=" <?=url('_assets/img/img/orang (2).png')?>" alt="" class="box-img-orang">
					<img src=" <?=url('_assets/img/img/celana.png')?>" alt="" class="box-img-celana">
					<img src=" <?=url('_assets/img/img/kaos.png')?>" alt="" class="box-img-kaos">
					<img src=" <?=url('_assets/img/img/jaket.png')?>" alt="" class="box-img-kemeja">
