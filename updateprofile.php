	...
	<?php if (update_kary($_POST) > 0) :?>
		...
		<div class="alert">
			<div class="box">
				...
				<button onclick="window.location='http://localhost/rumah_laundry/index.php'" class="btn-alert">Ok</button>
			</div>
		</div>
				...
				<div class="card">
					<div class="card-title card-flex">
						...
						<div class="card-col txt-right">
							<a href="profile.php?id_user=<?=$id_user?>" class="btn-xs bg-primary">Kembali</a>
						</div>
					</div>
					...
					<div class="card-body">
						<form action="" method="post" class="form-input">
							...
							<div class="form-grup ">
								<button type="submit" class="mt-1" name="update">Update</button>
							</div>
						</form>
					</div>
				</div>
